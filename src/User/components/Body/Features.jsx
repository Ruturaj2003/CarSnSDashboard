const Features = () => {
  return (
    <div className="w-full flex flex-col  py-10 px-5 bg-orange-400">
      {/* Card 1 */}
      <div className="flex w-full mb-10">
        <div className="w-[55%]  h-[500px] flex pr-16 flex-col items-end justify-center  ">
          <h1 className="font-slogan text-4xl mb-3">
            Exclusive, Top-Quality <br /> Vehicles
          </h1>
          <p className="w-[400px] mr-[85px] text-3xl font-semibold">
      ...
      <div className="flex w-full mb-10">
        ...
        <div className="w-[55%]  h-[500px] flex pl-16 flex-col items-start justify-center  ">
          ...
          <p className="w-[400px] text-3xl font-semibold">
