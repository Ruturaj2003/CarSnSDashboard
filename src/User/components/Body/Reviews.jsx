    ...
    <div className="flex justify-evenly items-center h-[500px] w-full ">
      ...
      >
        ...
        <div className="h-[60%] w-full flex flex-col">
          ...
          ></img>
          <h3 className="w-full p-3 font-normal">
            My BMW M5 glides on the road, thanks to precision engineering!
          </h3>
        </div>
        {/* Name */}
        <div className="h-[10%] w-full font-normal ">Madara Uchiha</div>
      </div>
      ...
      >
        ...
        {/* Name */}
        <div className="h-[10%] w-full font-normal ">Ninja Hatori</div>
      </div>
      ...
      >
        ...
        {/* Name */}
        <div className="h-[10%] w-full font-normal ">Nobita</div>
      </div>
    </div>
  );
};
